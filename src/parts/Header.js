      ...
      <div className="container py-5 mx-auto">
        <div className="flex items-center flex-stretch">
          ...
          <div className="w-auto">
            <ul
              className="fixed inset-0 flex flex-col items-center justify-center invisible font-medium bg-white opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
              id="menu"
            >
